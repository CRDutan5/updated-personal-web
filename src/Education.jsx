  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-screen-xl p-8 gap-y-8 grid grid-cols-1 md:grid-cols-1 gap-x-8">
        <div className="bg-gray-500 bg-clip-padding backdrop-filter  backdrop-blur bg-opacity-10 backdrop-saturate-100 backdrop-contrast-100 border-8 border-blue-600 p-8 rounded-3xl shadow-[-28px_40px_38px_7px_rgba(0,_0,_0,_0.1)]">
