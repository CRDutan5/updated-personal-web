...
const Nav = () => {
  ...
  return (
    ...
    <div className="pt-6 text-strongblue flex justify-end gap-10 text-2xl max-sm:hidden">
      <div>
        <h1 className="border-b-4 border-transparent hover:border-blue-600 transition-all duration-300">
          Home
        </h1>
      </div>
      <div className="">
      ...
      <div>
        <h1 className="border-b-4 border-transparent mr-10 hover:border-blue-600 transition-all duration-300">
          Projects
        </h1>
      </div>
    </div>
